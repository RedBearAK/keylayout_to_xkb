# Choctaw — keyboard layout reference
...
| LeftBracket | `ʋ` | U+028B | LATIN SMALL LETTER V WITH HOOK |
| RightBracket | ⟨dead key⟩ | | Dead key: Combining Macron Below |
...
| LeftBracket | `Ʋ` | U+01B2 | LATIN CAPITAL LETTER V WITH HOOK |
| RightBracket | ⟨dead key⟩ | | Dead key: Combining Macron Below |
...
### Combining Macron Below (reached by RightBracket)


Standalone accent: `̱` (COMBINING MACRON BELOW). 6 compositions.
