# Serbian — keyboard layout reference
...
| Y | `з` | U+0437 | CYRILLIC SMALL LETTER ZE |
...
| RightBracket | `ђ` | U+0452 | CYRILLIC SMALL LETTER DJE |
...
| Quote | `ћ` | U+045B | CYRILLIC SMALL LETTER TSHE |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Z | `ѕ` | U+0455 | CYRILLIC SMALL LETTER DZE |
...
| Y | `З` | U+0417 | CYRILLIC CAPITAL LETTER ZE |
...
| RightBracket | `Ђ` | U+0402 | CYRILLIC CAPITAL LETTER DJE |
...
| Quote | `Ћ` | U+040B | CYRILLIC CAPITAL LETTER TSHE |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Z | `Ѕ` | U+0405 | CYRILLIC CAPITAL LETTER DZE |
...
| 9 | `9` | U+0039 | DIGIT NINE |
| 0 | `0` | U+0030 | DIGIT ZERO |
| Minus | `‘` | U+2018 | LEFT SINGLE QUOTATION MARK |
| Equal | `+` | U+002B | PLUS SIGN |
...
### Greater-Than Sign (reached by ?)


Standalone accent: `>` (GREATER-THAN SIGN). 11 compositions.


| Base | Result | Code point | Description |
|------|--------|-----------|-------------|
| (space) | `>` | U+003E | GREATER-THAN SIGN |
| `>` | `»` | U+00BB | RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK |
| `Ј` | `Ь` | U+042C | CYRILLIC CAPITAL LETTER SOFT SIGN |
| `А` | `Я` | U+042F | CYRILLIC CAPITAL LETTER YA |
| `Г` | `Ѓ` | U+0403 | CYRILLIC CAPITAL LETTER GJE |
| `Е` | `э` | U+044D | CYRILLIC SMALL LETTER E |
| `И` | `Й` | U+0419 | CYRILLIC CAPITAL LETTER SHORT I |
| `О` | `Ы` | U+042B | CYRILLIC CAPITAL LETTER YERU |
| `У` | `ю` | U+044E | CYRILLIC SMALL LETTER YU |
| `Х` | `Ъ` | U+042A | CYRILLIC CAPITAL LETTER HARD SIGN |
| `Ш` | `Щ` | U+0429 | CYRILLIC CAPITAL LETTER SHCHA |
...
| `o` | `є` | U+0454 | CYRILLIC SMALL LETTER UKRAINIAN IE |
| `r` | `ґ` | U+0491 | CYRILLIC SMALL LETTER GHE WITH UPTURN |
| `y` | `ў` | U+045E | CYRILLIC SMALL LETTER SHORT U |
| `–` | `¬` | U+00AC | NOT SIGN |
...
Standalone accent: `~` (TILDE). 16 compositions.
...
| `O` | `Є` | U+0404 | CYRILLIC CAPITAL LETTER UKRAINIAN IE |
| `R` | `®` | U+00AE | REGISTERED SIGN |
| `V` | `√` | U+221A | SQUARE ROOT |
| `Y` | `Ў` | U+040E | CYRILLIC CAPITAL LETTER SHORT U |
