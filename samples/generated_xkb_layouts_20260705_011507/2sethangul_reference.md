# 2-Set Korean — keyboard layout reference
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Q | `ㅂ` | U+3142 | HANGUL LETTER PIEUP |
| W | `ㅈ` | U+3148 | HANGUL LETTER CIEUC |
| E | `ㄷ` | U+3137 | HANGUL LETTER TIKEUT |
| R | `ㄱ` | U+3131 | HANGUL LETTER KIYEOK |
| T | `ㅅ` | U+3145 | HANGUL LETTER SIOS |
| Y | `ㅛ` | U+315B | HANGUL LETTER YO |
| U | `ㅕ` | U+3155 | HANGUL LETTER YEO |
| I | `ㅑ` | U+3151 | HANGUL LETTER YA |
| O | `ㅐ` | U+3150 | HANGUL LETTER AE |
| P | `ㅔ` | U+3154 | HANGUL LETTER E |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| A | `ㅁ` | U+3141 | HANGUL LETTER MIEUM |
| S | `ㄴ` | U+3134 | HANGUL LETTER NIEUN |
| D | `ㅇ` | U+3147 | HANGUL LETTER IEUNG |
| F | `ㄹ` | U+3139 | HANGUL LETTER RIEUL |
| G | `ㅎ` | U+314E | HANGUL LETTER HIEUH |
| H | `ㅗ` | U+3157 | HANGUL LETTER O |
| J | `ㅓ` | U+3153 | HANGUL LETTER EO |
| K | `ㅏ` | U+314F | HANGUL LETTER A |
| L | `ㅣ` | U+3163 | HANGUL LETTER I |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Z | `ㅋ` | U+314B | HANGUL LETTER KHIEUKH |
| X | `ㅌ` | U+314C | HANGUL LETTER THIEUTH |
| C | `ㅊ` | U+314A | HANGUL LETTER CHIEUCH |
| V | `ㅍ` | U+314D | HANGUL LETTER PHIEUPH |
| B | `ㅠ` | U+3160 | HANGUL LETTER YU |
| N | `ㅜ` | U+315C | HANGUL LETTER U |
| M | `ㅡ` | U+3161 | HANGUL LETTER EU |
| Comma | `,` | U+002C | COMMA |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Q | `ㅃ` | U+3143 | HANGUL LETTER SSANGPIEUP |
| W | `ㅉ` | U+3149 | HANGUL LETTER SSANGCIEUC |
| E | `ㄸ` | U+3138 | HANGUL LETTER SSANGTIKEUT |
| R | `ㄲ` | U+3132 | HANGUL LETTER SSANGKIYEOK |
| T | `ㅆ` | U+3146 | HANGUL LETTER SSANGSIOS |
| Y | `ㅛ` | U+315B | HANGUL LETTER YO |
| U | `ㅕ` | U+3155 | HANGUL LETTER YEO |
| I | `ㅑ` | U+3151 | HANGUL LETTER YA |
| O | `ㅒ` | U+3152 | HANGUL LETTER YAE |
| P | `ㅖ` | U+3156 | HANGUL LETTER YE |
