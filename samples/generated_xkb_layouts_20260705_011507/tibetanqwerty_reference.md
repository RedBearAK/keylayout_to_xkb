# Tibetan - QWERTY — keyboard layout reference
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| A | `༂` | U+0F02 | TIBETAN MARK GTER YIG MGO -UM RNAM BCAD MA |
...
| Slash | `༎` | U+0F0E | TIBETAN MARK NYIS SHAD |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| Q | `༁` | U+0F01 | TIBETAN MARK GTER YIG MGO TRUNCATED A |
...
| Key | Output | Code point | Description |
|-----|--------|-----------|-------------|
| A | `༃` | U+0F03 | TIBETAN MARK GTER YIG MGO -UM GTER TSHEG MA |
...
Standalone accent: `྄` (TIBETAN MARK HALANTA). 35 compositions.
...
| `ཊ` | `ྚ` | U+0F9A | TIBETAN SUBJOINED LETTER TTA |
